...
def link_grabber(search_item):
    ...
    try:
        ...
        error = True
        print("Exception at: " + search_item)
...
def main(search_item, final_item, counter):
    '''
    ...
    return main(search_item, final_item, counter)

search_item = 'Adolf Hitler'
final_item = 'Mars'

#Printing results
print("\n\nSearching for a path between '" + search_item + "' and '" + final_item + "'")
_ = main(search_item, final_item, 0)
...
ans.reverse()
print(*ans, sep=' -> ')
print("It took "+ str(len(ans)) + " sites! Can you do better?")